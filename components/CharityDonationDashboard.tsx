    ...
    return (
        <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-8 animate-in fade-in duration-700 pb-20 px-4 md:px-0">
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-start">
                ...
                {/* Narrative Column */}
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-white rounded-[3.5rem] p-8 shadow-2xl shadow-[#5A2C10]/10 border border-[#5A2C10]/5 h-full flex flex-col">
                        ...
                        <div className="relative mb-10 overflow-hidden">
                            ...
                            <p className="relative z-10 text-xl font-bold text-[#5A2C10] leading-relaxed italic px-6 py-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-auto">
                            ...
                            <div className="bg-[#FF9248]/5 p-6 rounded-3xl border border-[#FF9248]/5 transition-colors hover:bg-[#FF9248]/10">
                                ...
                                <p className="text-xl font-black text-[#5A2C10] uppercase tracking-tighter truncate">{donation.type}</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 pt-8 border-t border-gray-100 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-black text-[#5A2C10] truncate max-w-[120px]">{donation.donor_name}</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">METHOD</p>
                                <p className="font-black text-[#5A2C10] uppercase tracking-tighter truncate max-w-[100px]">{donation.delivery_preference || 'pickup'}</p>
                            </div>
                        </div>
                    </div>
                </div>
