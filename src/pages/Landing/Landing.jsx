      ...
      <div className="relative flex-[8]">
        ...
        <div className='absolute inset-0 bg-[linear-gradient(0deg,_rgba(0,0,0,0.87)_0%,_rgba(0,0,0,0.35)_52.4%,_rgba(102,102,102,0)_100%)] flex flex-col'>
          ...
          <div className="border-b border-white/20 mx-8">
            <nav className="flex items-center justify-between p-6">
              ...
              <div className='flex gap-x-10 text-white font-konkhmer text-[26px] font-normal'>
                <Link to="/login" className="relative text-white after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-[#647BD0] after:transition-all after:duration-300 hover:text-[#647BD0] hover:after:w-full">Login</Link>
                <Link to="/sign_up" className="relative text-white after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-[#647BD0] after:transition-all after:duration-300 hover:text-[#647BD0] hover:after:w-full">Sign up</Link>
              </div>
            </nav>
          </div>
          ...
          <div className='flex-1 flex flex-col items-center justify-center'>
            ...
            <p className="text-white text-center font-['Hind_Guntur'] text-1xl font-extralight">Connect with local organizations and ensure your usable<br />goods go where they're needed most</p>
            <button className="relative py-2 px-8 text-white text-base font-bold rounded-full overflow-hidden bg-[#647BD0] w-[275px] max-w-full transition-all duration-400 ease-in-out shadow-md hover:scale-105 hover:text-white hover:shadow-lg active:scale-90 before:absolute before:top-0 before:-left-full before:w-full before:h-full before:bg-gradient-to-r before:from-[#647BD0] before:to-[#FF9248] before:transition-all before:duration-500 before:ease-in-out before:z-[-1] before:rounded-full hover:before:left-0 mt-7">
              Get Started
            </button>
          </div>
      ...
      <div className='flex-[3] bg-white flex flex-col items-center justify-center'>
        ...
        <div className="flex justify-center items-start gap-x-16">
          ...
          <div className="flex flex-col items-center gap-y-3 w-35 max-w-full">
            <img src="/Camera_Icon.png" className="w-12 h-12 object-contain" />
            <p className="text-black text-center font-['Koulen'] text-[20px]">1. Snap & Describe</p>
          </div>

          <div className="flex flex-col items-center gap-y-3 w-35 max-w-full">
            <img src="/Contact_Icon.png" className="w-12 h-12 object-contain" />
            <p className="text-black text-center font-['Koulen'] text-[20px]">2. Get Matched</p>
          </div>

          <div className="flex flex-col items-center gap-y-3 w-35 max-w-full">
            <img src="/Donate_Icon.png" className="w-12 h-12 object-contain" />
