...
export default async function LandingPage() {
  ...
  return (
    <div className='min-h-screen md:h-screen flex flex-col'>
      <div className="relative flex-1 md:flex-[8] min-h-[70vh] md:min-h-0">
        ...
        <div className='absolute inset-0 bg-[linear-gradient(0deg,_rgba(0,0,0,0.87)_0%,_rgba(0,0,0,0.35)_52.4%,_rgba(102,102,102,0)_100%)] flex flex-col'>
          ...
          <div className="border-b border-white/20 mx-4 md:mx-8">
            <nav className="flex items-center justify-between p-4 md:p-6">
              ...
              <div className='flex gap-x-4 md:gap-x-10 text-white font-konkhmer text-xl md:text-[26px] font-normal'>
                {user ? (
          ...
          <div className='flex-1 flex flex-col items-center justify-center'>
            <h1 className="text-white text-center font-montserrat text-4xl md:text-[70px] font-light leading-[1] mb-4">Give Your Pre-Loved<br />Items a New Purpose</h1>
            <p className="text-white text-center font-hind-guntur text-base md:text-xl font-extralight px-4 md:px-0 mt-4 md:mt-0">Connect with local organizations and ensure your usable<br className="hidden md:block" />goods go where they're needed most</p>
      ...
      <div className='py-12 md:py-0 md:flex-[3] bg-white flex flex-col items-center justify-center'>
        <h3 className="text-black text-center font-koulen text-[30px] font-normal mb-8 md:mb-6">HOW IT WORKS</h3>

        <div className="flex flex-col md:flex-row items-center justify-center gap-y-10 md:gap-y-0 gap-x-16 w-full px-4">

          <div className="flex flex-col items-center gap-y-3 w-36 max-w-full">
