...
export default async function LandingPage() {
  ...
  return (
    <div className='h-screen flex flex-col'>
      <div className="relative flex-[8]">
        ...
        <div className='absolute inset-0 bg-[linear-gradient(0deg,_rgba(0,0,0,0.87)_0%,_rgba(0,0,0,0.35)_52.4%,_rgba(102,102,102,0)_100%)] flex flex-col'>
          ...
          <div className='flex-1 flex flex-col items-center justify-center px-4'>
            <h1 className="text-white text-center font-montserrat text-4xl md:text-[70px] font-light leading-tight md:leading-[1] mb-4">Give Your Pre-Loved<br className="hidden md:block" />Items a New Purpose</h1>
            <p className="text-white text-center font-hind-guntur text-sm md:text-base font-extralight max-w-2xl">Connect with local organizations and ensure your usable<br className="hidden md:block" />goods go where they're needed most</p>
      ...
      <div className='flex-[3] bg-white flex flex-col items-center justify-center py-12'>
        <h3 className="text-black text-center font-koulen text-2xl md:text-[30px] font-normal mb-8 md:mb-6">HOW IT WORKS</h3>

        <div className="flex flex-col md:flex-row justify-center items-center gap-y-10 md:gap-x-16 px-4">

          <div className="flex flex-col items-center gap-y-3 w-full md:w-35 max-w-full">
